"""
Code to train the FasterRCNN network used in our experiments.

Based on the 'train.py' code in longcw's pytorch implementation:
...
from vsrseg.faster_rcnn_helpers.helpers import \
        R50FasterRCNN, load_pretrained_r50frcnn
...
cfg_file = 'vsrseg/faster_rcnn_helpers/faster_rcnn_end2end.yml'
pretrained_model = 'data/pretrained_model/VGG_imagenet.npy'
#saved_models/VGGnet_fast_rcnn_iter_70000.h5
output_dir = 'saved_models/faster_rcnn_train'
...
# load net
net = R50FasterRCNN(classes=imdb.classes, debug=_DEBUG)
network.weights_normal_init(net, dev=0.01)
load_pretrained_r50frcnn(net)
